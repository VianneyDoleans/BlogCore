...
namespace MyBlogAPI.Permissions
{
    ...
    public class OwnOrAllPermissionRangeForHasUserDtoAuthorizationHandler<TDto> : AuthorizationHandler<PermissionRequirement, TDto>
    where TDto : IHasUser
    {
        ...
        /// <inheritdoc />
        public OwnOrAllPermissionRangeForHasUserDtoAuthorizationHandler(IUserService userService, IRoleService roleService, IMapper mapper)
        {
        ...
        /// <inheritdoc />
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, PermissionRequirement requirement, TDto entity)
        {
            ...
            if (user.Roles.Any())
            {
                ...
                foreach (var role in user.Roles)
                {
                    ...
                    if (permissions != null && permissions.Any(permission =>
                            ...
                            ((permission.PermissionRange.Id == (int)PermissionRange.Own && entity.User == userId)
